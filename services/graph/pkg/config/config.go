...
type LDAPEducationConfig struct {
	...
	SchoolTerminationGraceDays int `yaml:"school_termination_min_grace_days" env:"GRAPH_LDAP_SCHOOL_TERMINATION_MIN_GRACE_DAYS" desc:"The minimal time period (in days), which the terminationDate of a School needs to be in the future, when updating it."`
}
